...
public class MusicPlayerBottomSheetGroup extends BottomSheetDialogFragment {
    
    public static final String TAG = "MusicPlayerBottomSheetGroup";
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction() != null) {
                switch (intent.getAction()) {
                    case AudioPlaybackServiceGroup.ACTION_PLAY:
                        isPlaying = true;
                        ...
                        startSeekBarUpdate();
                        break;
                    case AudioPlaybackServiceGroup.ACTION_PAUSE:
                        isPlaying = false;
                        ...
                        stopSeekBarUpdate();
                        break;
                    case AudioPlaybackServiceGroup.ACTION_COMPLETED:
                        isPlaying = false;
                        updatePlayPauseButton(false);
                        if (profileImageView != null) {
                            profileImageView.clearAnimation();
                        ...
                        stopSeekBarUpdate();
                        break;
                    case AudioPlaybackServiceGroup.ACTION_UPDATE_PROGRESS:
    ...
    public static MusicPlayerBottomSheetGroup newInstance(String audioUrl, String profileImageUrl, String songTitle,String grpIdKey,String nameKey,String captionKey) {
        MusicPlayerBottomSheetGroup fragment = new MusicPlayerBottomSheetGroup();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        filter.addAction(AudioPlaybackServiceGroup.ACTION_PLAY);
        filter.addAction(AudioPlaybackServiceGroup.ACTION_PAUSE);
        filter.addAction(AudioPlaybackServiceGroup.ACTION_COMPLETED);
        filter.addAction(AudioPlaybackServiceGroup.ACTION_UPDATE_PROGRESS);
        if (getContext() != null) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        playPauseButton.setOnClickListener(v -> {
            ...
            intent.setAction(isPlaying ? AudioPlaybackServiceGroup.ACTION_PAUSE : AudioPlaybackServiceGroup.ACTION_PLAY);
            if (getContext() != null) {
        ...
        if (getContext() != null) {
            Intent serviceIntent = new Intent(getContext(), AudioPlaybackServiceGroup.class);
            ...
            serviceIntent.putExtra("grpIdKey", grpIdKey); // <-- Add this!
