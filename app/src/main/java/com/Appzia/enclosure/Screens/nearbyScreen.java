...
import com.Appzia.enclosure.databinding.ActivityNearbyScreenBinding;

public class nearbyScreen extends AppCompatActivity {

    ActivityNearbyScreenBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityNearbyScreenBinding.inflate(getLayoutInflater());
        ...
        binding.backarrow.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                SwipeNavigationHelper.startActivityWithSwipe(nearbyScreen.this, new Intent(getApplicationContext(),sponsred.class));
            }
        });
    }
}