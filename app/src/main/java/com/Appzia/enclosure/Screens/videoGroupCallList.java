...
import com.Appzia.enclosure.databinding.ActivityVideoGroupCallListBinding;
import com.google.firebase.database.DatabaseReference;

import java.util.ArrayList;

public class videoGroupCallList extends AppCompatActivity {
    ActivityVideoGroupCallListBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityVideoGroupCallListBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        mContext = videoGroupCallList.this;
