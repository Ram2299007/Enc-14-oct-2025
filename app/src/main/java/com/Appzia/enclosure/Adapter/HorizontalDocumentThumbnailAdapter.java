...
public class HorizontalDocumentThumbnailAdapter extends RecyclerView.Adapter<HorizontalDocumentThumbnailAdapter.DocumentThumbnailViewHolder> {
    ...
    public HorizontalDocumentThumbnailAdapter(Context context, List<Uri> documentUris, OnThumbnailClickListener listener) {
    ...
    public DocumentThumbnailViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_horizontal_document_thumbnail, parent, false);
