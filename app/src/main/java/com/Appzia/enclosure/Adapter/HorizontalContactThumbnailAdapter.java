...
public class HorizontalContactThumbnailAdapter extends RecyclerView.Adapter<HorizontalContactThumbnailAdapter.ViewHolder> {
    ...
    public interface OnContactClickListener {
        void onContactClick(int position, chattingScreen.ContactInfo contactInfo);
    }
    
    public HorizontalContactThumbnailAdapter(Context context, List<chattingScreen.ContactInfo> contactInfos) {
