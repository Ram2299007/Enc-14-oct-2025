...
public class GroupContactPreviewAdapter extends RecyclerView.Adapter<GroupContactPreviewAdapter.ViewHolder> {
    
    private Context context;
    private List<grpChattingScreen.ContactInfo> contactInfos;
    
    public GroupContactPreviewAdapter(Context context, List<grpChattingScreen.ContactInfo> contactInfos) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        android.util.Log.d("GroupContactPreviewAdapter", "Binding contact " + position + ": " + contactInfo.name);
