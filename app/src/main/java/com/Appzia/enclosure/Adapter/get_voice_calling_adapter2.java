...
public class get_voice_calling_adapter2 extends RecyclerView.Adapter<get_voice_calling_adapter2.myViewHolder> {
    Context mContext;
    ...
    public get_voice_calling_adapter2(Context mContext, ArrayList<get_contact_model> get_calling_contact_list,
        ...
        holder.clickView.setOnClickListener(v -> {
            ...
            if (!sleepKey.equals(Constant.sleepKey)) {
                FcmNotificationsSender notificationsSender = new FcmNotificationsSender(
                        model.getF_token(), "Enclosure", Constant.voicecall, mContext,
                ...
                Constant.showCustomToast("Calling...", customToastCard, customToastText);
